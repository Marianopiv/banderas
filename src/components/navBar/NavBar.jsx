...
const NavBar = () => {
  ...
  return (
    <div  className={`flex justify-between gap-5 ${darkMode?"bg-slate-700 text-white":"bg-white"} px-3 py-8 hover:cursor-pointer`} >
      <div className=""><h3 className="text-sm font-bold">Where in the world?</h3></div>
      <div onClick={toogleDarkMode} className="flex gap-2"><img className={`w-4 h-4 -rotate-45 ${darkMode?"invert":""}`} src={moon} alt="" />
